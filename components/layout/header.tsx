...
//         Skip to content
//       </a>
//       <Link href="/" className="logo-link" aria-label={`${siteConfig.brand.name} home`}>
//         <BrandLogo />
//       </Link>
//       <nav className="desktop-nav" aria-label="Main navigation">
//         {links
//           .filter((n) => !['/', '/#contact'].includes(n.href))
//           .map((n) => (
//             <Link
//               key={n.href}
//               href={n.href}
...
//           <button className="mobile-menu-button icon-button" aria-label="Open navigation">
//             <Menu size={24} />
//           </button>
//         </DialogTrigger>
...
export function Header({ hasClients = false }: { hasClients?: boolean }) {
  ...
  const links = siteConfig.navigation.filter(
    (n) => n.requires !== "clients" || hasClients,
  );
